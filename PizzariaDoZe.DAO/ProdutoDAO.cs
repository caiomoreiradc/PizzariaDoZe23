...
namespace PizzariaDoZe.DAO
{
    public class ProdutoDAO
    {
        ...
        public int Inserir(Produto produto)
        {
            ...
            var descricao = comando.CreateParameter(); descricao.ParameterName = "@nome_produto";
            ...
            comando.CommandText = @"" +
            "INSERT INTO cad_produtos (nome_produto, valor, tipo, medida_unitaria) " +
            "VALUES (@nome_produto, @valorProduto, @tipo, @ml);" +
            auxSQL_ID;
        ...
        public DataTable Buscar(Produto produto)
        {
            ...
            conexao.Open();
            comando.CommandText = @" " +
            "SELECT id_produto AS ID, nome_produto AS Nome, valor AS Valor, tipo AS 'Tipo Produto', medida_unitaria AS ML " + "FROM cad_produtos AS p " + auxSqlFiltro + "ORDER BY p.nome_produto;";
