...
namespace PizzariaDoZe.DAO
{
    public class ValorDAO
    {
        ...
        public int Inserir(Valor valor)
        {
            ...
            comando.CommandText = @"" +
            "INSERT INTO tb_valor (tamanho, categoria, valor_pizza, valor_borda) " +
        ...
        public DataTable Buscar(Valor valor)
        {
            ...
            conexao.Open();
            comando.CommandText = @" " +
            "SELECT id_valor AS ID, tamanho AS Tamanho, categoria AS Categoria, valor_pizza AS ValorPizza, valor_borda AS 'ValorBorda' " +"FROM tb_valor AS v " + auxSqlFiltro +
";";
