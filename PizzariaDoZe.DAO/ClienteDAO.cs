...
public class ClienteDAO
{
    ...
    public int Inserir(Cliente cliente)
    {
        ...
        comando.CommandText = @"INSERT INTO tb_clientes (nome_cliente, cpf, telefone, email, endereco_id, complemento)
        VALUES(@nome, @cpf, @telefone, @email, @endereco_id,@complemento);" + auxSQL_ID;
    ...
    public DataTable Buscar(Cliente cliente)
    {
        ...
        "e.cep AS CEP, e.logradouro AS Logradouro," +
